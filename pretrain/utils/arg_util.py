...
class Args(Tap):
    # environment
    exp_name: str = 'try'
    exp_dir: str = '/mai_nas/LSH/SparK/exp/try'   # will be created if not exists
    ...
    resume_from: str = '/mai_nas/LSH/SparK/exp/basic/resnet50_withdecoder_epoch1550.pth'   # resume the experiment from some checkpoint.pth; load model weights, optimizer states, and last epoch
